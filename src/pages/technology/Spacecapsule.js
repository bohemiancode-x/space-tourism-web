import Capsulept from '../../assets/technology/image-space-capsule-portrait.jpg'
import Capsulels from '../../assets/technology/image-space-capsule-landscape.jpg'

export default function Spacecapsule({data}) {
  return (
    <div>
        <div className='flex lg:flex-row flex-col items-center lg:items-start'>
            ...
            <div className='lg:ml-auto lg:pl-10'>
                <img className='h-[28rem] mt-20 md:mt-0 md:h-[32rem] hidden lg:block lg:h-full' src={Capsulept} alt='img' />
                <img className='mt-0 h-[22rem] w-full lg:hidden' src={Capsulels} alt='img' />
            </div>
        </div>
    </div>
  )
